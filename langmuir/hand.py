...
class data_class():
    ...
    def get_etemps(self):
        ...
        fig1.plot(self.U[:20], regress2.slope * np.array(self.U[:20]) + regress2.intercept,label="Fit $U>\Phi_P$")
        plt.tight_layout()
        plt.legend()
        #plt.show()
        #print(regress1)
        ...
        self.Dphip1=regress1.intercept_stderr*regress2.intercept*(regress1.slope-regress2.slope)+regress2.intercept_stderr*regress1.intercept*(regress1.slope-regress2.slope)+regress1.stderr*(regress1.intercept-regress2.intercept)/(regress1.slope-regress2.slope)**2+regress2.stderr*(regress1.intercept-regress2.intercept)/(regress1.slope-regress2.slope)**2
        ...
        print(self.Te1, self.DTe1, self.Te2, self.DTe2)
        print(self.phip1,self.Dphip1)
        print(self.Te3)
